...
/**
 * Defines restore_coursebadges_activity_task class.
 *
...
/**
 * Class restore_coursebadges_activity_task.
 *
 * Coursebadges restore task that provides all the settings and steps to perform one complete restore of the activity.
 *
 * @package     mod_coursebadges
 * @copyright   2020 Reseau-Canope
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
